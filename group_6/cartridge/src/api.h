...
/**
 * Computes a control value for small sprites based on their dimensions and
 * position.
 ...
 */
uint32_t generateSmallSpriteConfig(uint32_t x, uint32_t y, uint32_t w,
                                   uint32_t h, uint32_t p);

/**
 * Calculates the control value for a large sprite based on its position and
 * size.
 ...
 */
uint32_t generateLargeSpriteConfig(uint32_t x, uint32_t y, uint32_t w,
                                   uint32_t h, uint32_t p);

/**
 * Determines the control settings for a background based on its position and
 * palette.
 ...
 */
uint32_t generateBackgroundConfig(uint32_t x, uint32_t y, uint32_t z,
                                  uint32_t p);
